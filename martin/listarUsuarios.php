<?php
  ...
  $tabela = $pdo->prepare("SELECT idusuario, nome, login, senha, sobrenome FROM martin;");
...
<html>
  ...
  <thead>
    <tr class="retprin" >
      ...
      <th class="login" scope="col">Login</th>
      <th class="senha" scope="col">Senha</th>
      <th class="nome" scope="col">Nome</th>
      <th class="sobrenome" scope="col">Sobrenome</th>
  ...
  <tbody>
    ...
    foreach($rowTabela as $linha){
      ...
      echo "<td class='retsobrenome text'>".$linha['sobrenome']."</td>";
